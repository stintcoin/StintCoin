...
// Copyright (c) 2014-2017 The DASH and PIVX Core Developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:27501", "127.0.0.1", 27501));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:27501", "127.0.0.1", 27501));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:27501", "::ffff:127.0.0.1", 27501));
    BOOST_CHECK(TestSplitHost("[::]:27501", "::", 27501));
    BOOST_CHECK(TestSplitHost("::27501", "::27501", -1));
    BOOST_CHECK(TestSplitHost(":27501", "", 27501));
    BOOST_CHECK(TestSplitHost("[]:27501", "", 27501));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:27501", "127.0.0.1:27501"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:27501", "[::]:27501"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
