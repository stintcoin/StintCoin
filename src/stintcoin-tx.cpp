...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("StintCoin Core stintcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stintcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stintcoin transaction") + "\n" +
                               "  stintcoin-tx [options] -create [commands]   " + _("Create hex-encoded stintcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stintcoin transaction
