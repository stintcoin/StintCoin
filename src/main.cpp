...
#if defined(NDEBUG)
#error "StintCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "StintCoin Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if(nHeight <= 1 && nHeight > 0) 
        ...
        nSubsidy = 1 * COIN;
    else if (nHeight > 5000 && nHeight <= 21000)
        nSubsidy = 4 * COIN;
    else if (nHeight > 21000 && nHeight <= 34000)
        nSubsidy = 5 * COIN;
    else if (nHeight > 34000 && nHeight <= 56000)
        nSubsidy = 7 * COIN;
    else if (nHeight > 56000 && nHeight <= 76000)
        nSubsidy = 11 * COIN;
    else if (nHeight > 76000 && nHeight <= 132000)
        nSubsidy = 19 * COIN;
    else if (nHeight > 132000 && nHeight <= 166000)
        nSubsidy = 32 * COIN;
    else if (nHeight > 166000 && nHeight <= 280000)
        nSubsidy = 19 * COIN;
    else
        nSubsidy = 5 * COIN;
...
{
    RenameThread("stintcoin-scriptch");
