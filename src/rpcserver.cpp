...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "StintCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* STINT features */
        {"stintcoin", "masternode", &masternode, true, true, false},
        {"stintcoin", "masternodelist", &masternodelist, true, true, false},
        {"stintcoin", "mnbudget", &mnbudget, true, true, false},
        {"stintcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"stintcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"stintcoin", "mnsync", &mnsync, true, true, false},
        {"stintcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use stintcoind, or the -server option to stintcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> stintcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27502/\n";
}
