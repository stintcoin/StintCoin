...
/** Utility functions used by the STINT Qt UI.
 */
namespace GUIUtil
{
...
// Render STINT addresses in monospace font
...
// Parse "stintcoin:" URI into recipient object, return true on successful parsing
