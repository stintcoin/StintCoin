...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("StintCoin Core"),
     ...
     * override -datadir in the stintcoin.conf file in the default data directory
     * (to be consistent with stintcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
