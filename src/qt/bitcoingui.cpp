                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("StintCoin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STINT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stintcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About StintCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about StintCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for StintCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STINT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STINT addresses"));
    ...
    openAction->setStatusTip(tr("Open a StintCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the StintCoin Core help message to get a list with possible STINT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("StintCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to StintCoin network", "", count));
}
...
{
    QString strTitle = tr("StintCoin Core"); // default title
