...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/stintcoin-cli.cpp \
           src/stintcoin-tx.cpp \
           src/stintcoin.cpp \
           src/db.cpp \
           ...
           src/qt/stintcoin.cpp \
           src/qt/stintcoinstrings.cpp \
...
RESOURCES += src/qt/stintcoin.qrc src/qt/stintcoin_locale.qrc

TRANSLATIONS += src/qt/locale/stintcoin_bg.ts \
                src/qt/locale/stintcoin_de.ts \
                src/qt/locale/stintcoin_en.ts \
                src/qt/locale/stintcoin_es.ts \
                src/qt/locale/stintcoin_fi.ts \
                src/qt/locale/stintcoin_fr.ts \
                src/qt/locale/stintcoin_it.ts \
                src/qt/locale/stintcoin_ja.ts \
                src/qt/locale/stintcoin_pl.ts \
                src/qt/locale/stintcoin_pt.ts \
                src/qt/locale/stintcoin_ru.ts \
                src/qt/locale/stintcoin_sk.ts \
                src/qt/locale/stintcoin_sv.ts \
                src/qt/locale/stintcoin_vi.ts \
                src/qt/locale/stintcoin_zh_CN.ts \
                src/qt/locale/stintcoin_zh_TW.ts
