...
In order to support loading of multiple wallets in stintcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stintcoin.cpp.
...
Changes to stintcoin.cpp
----------------------
stintcoin.cpp is the entry point into stintcoin-qt, and as such, will require some minor modifications to provide hooks for
